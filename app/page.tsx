    ...
    <>
      ...
      <header className="site-header section-shell">
        ...
        <nav aria-label="Primary navigation">
          ...
          <button type="button" disabled title="Code link not yet available">Code</button>
        </nav>
      </header>
      ...
      <main id="main">
        <section className="hero section-shell" id="top">
          ...
          <div className="resource-links" aria-label="Paper and code">
            <a className="paper-link" href="/paper.pdf" target="_blank" rel="noreferrer">Paper</a>
            <button className="paper-link code-link" type="button" disabled title="Code link not yet available">Code</button>
          </div>
          ...
          <figure className="overview-film">
            <Video src="/videos/teaser.mp4" label="Teaser for Track, Articulate, Act" />
          </figure>
        </section>
